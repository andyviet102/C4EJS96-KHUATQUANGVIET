...
function detailPro(id) {
  ...
  <div style="text-align: center;font-family: 'FontAwesome';font-size: 32px">Tác Phẩm</div>
  <div class="detail_Pro" style="display:flex;">
    ...
    <div class="detail_all" style="width:50%; font-family: 'FontAwesome';">
      <p style="font-size:30px;font-family: 'FontAwesome';" >${found.category}</p>
      <div style="font-size:50px;font-family: 'FontAwesome';">${found.name}</div>
      <div style="font-size:30px;font-family: 'FontAwesome';">Tên tác giả: ${found.price}</div>
      <p style="font-size:30px;font-family: 'FontAwesome';">Năm sáng tác: ${found.brand}</h1>
      <div id="selectsize" ><div style="font-size:30px;font-family: 'FontAwesome';">Nội dung và đặc sắc nghệ thuật:</div>
        
      </div>
      <div id="selectsize" ><div style="font-size:30px;font-family: 'FontAwesome';">Nội dung thơ:</div>
