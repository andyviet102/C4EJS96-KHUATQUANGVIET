...
console.log('Trả về giá trị index trong mảng');
console.log(`Math.floor đi cùng với Math.random để trả về giá trị số nguyên`);
//1.3
const Questions=[
    {
        name: 'Sweets made from what?',
        answer: ['1.Bread','2.Honey', '3.Sugar','4.Potent'],
    },
    {
        name:' What is the best game?',
        answer: ['1.dota2, 2.lol, 3.csgo, 4.pubg'],
    },
    {
        name:'What do you want most?',
        answer: ['1.money', '2.girlfriend', '3.car', '4.flat'],
    },
    {
        name: 'What is the dish with eggs?',
        answer: ['1.omelet', '2.noodles', '3.bread', '4.rice'],
    },
]
...
let x = prompt(`${Questions[random].name} 
${Questions[random].answer}`
);
// 1.5
const random = Math.floor(Math.random() * Questions.length);
let z = prompt(` ${Questions[random].name}${Questions[random].answer} `);
if(Questions[random].answer[(a-1)] == '1.omelet' || Questions[random].answer[(a-1)] == '2.girlfriend' || Questions[random].answer[(a-1)] == '1.dota2'|| Questions[random].answer[(a-1)] == '2.Honey')
{
      alert('Bravo!!!')
    }
    else
...
//1.6
   ...
   alert('sorry we run out if question :(((')
...
alert('you answered correctly '+ point+" out of 3")
//1.8
function shuffle(array){
    array.sort(() => Math.random()- 0.5);
}
...
alert(' sr we run out of question:((( ')
alert(' your answered correctly '+ point+ "out of 3")
 let c = prompt(`${Questions[i].name}
